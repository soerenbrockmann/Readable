...
└── src # Source files
    ...
    │   	├── handleCommentAction.js # Single comment related actions
    │       ├── handlePostAction.js # Single post related actions
    ...
    │		├── index.js # Exports component
    │ 	├── ShowPost
    │   	├── ShowPost.js # Renders a single post with related comments
    │   	├── ShowPost.css # Component specific styles
    │   	├── ShowPost.test.js # Component test
    │		├── index.js # Exports component
    │ 	├── Spinner
    ...
    │		├── index.js # Exports component
    │   ├── PostForm
    │   	├── PostForm.js # Renders a form to add or edit a post
    ...
    │   	├── handleCommentReducer.js # Single comment related reducer
    │     ├── handlePostReducer.js # Single post related reducer
    ...
    │   	├── handleCommentApiUtil.js # Single comment related thunks
    │       ├── handlePostApiUtil.js # Single post related thunks
...
## Important
Please note that this app is not entirely responsive yet and redux related tests must be extended.
